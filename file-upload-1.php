...
<main class="main-content">
  ...
  <div style="display:flex; gap:0.5rem; margin-bottom:2rem; flex-wrap:wrap;">
    <a href="/file-upload-1.php" class="btn btn-vuln" style="border: 2px solid var(--accent-red)">Level 1: No Validation</a>
    ...
    <section class="lab-section">
      ...
      <div class="vuln-box">
        ...
        <div class="webshell-demo">
          ...
          <a href="/public/uploads/fake-webshell.html" class="btn btn-sm btn-outline" target="_blank">🔗 Lihat Fake Webshell Demo</a>
        </div>
      </div>
    </section>
